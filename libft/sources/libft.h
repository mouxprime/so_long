...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/17 16:45:58 by mianni            #+#    #+#             */
/*   Updated: 2024/08/13 15:55:11 by mianni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_strlen_printf(const char *base);
...
size_t				ft_printf_putnbr_base(size_t nbr, const char type);
